...
system_prompt = """
Revise the following sentences to make them more clear, concise, and coherent . /n Please DO NOT note that you need to list the changes and briefly explain why. /n You will reply to me in Chinese.
"""

# Create chat completion with the Chat API 
completion = client.chat.completions.create(
    model= os.environ['POPCLIP_OPTION_MODEL'], # model = "deployment_name".
    messages=[
