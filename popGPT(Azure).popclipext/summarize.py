...
system_prompt = """
You are an assistant helping summarize a document. Use this format, replacing text in brackets with the result. Do not include the brackets in the output: /n/n Summary in [Identified language of the document]: /n/n[One-paragaph summary of the document using the identified language.].
"""
